            ...
            <div class="col-md-6">
                <form action="{{ route('posts.store') }}" method = "POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <textarea name = "post_description" rows = "10" cols = "10" class = "form-control" required></textarea>
                        </div>
                    </div>
                    </div>
                    <div class="form-group row">
                        ...
                        <div class="col-sm-8">
                            <input type="submit" name = "submit" class = "btn btn-sm btn-primary form-control" value = "Create Post">
                        </div>
                    </div>
                </form>
            </div>
